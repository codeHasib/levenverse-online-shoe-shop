      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[11px] leading-relaxed text-neutral-400 tracking-widest uppercase">
              Curating high-end sneakers and luxury apparel for the modern explorer. 
              Based in Doha, delivered to the world.
            </p>
            
            {/* SOCIAL ICONS USING SVG FOR STABILITY */}
            <div className="flex gap-6 items-center pt-2">
              <a href="#" className="text-neutral-400 hover:text-[#0070f3] transition-colors">
          ...
          {/* --- QUICK LINKS --- */}
          <div>
            <h4 className="text-[10px] tracking-[0.4em] uppercase font-bold text-black mb-8">Navigation</h4>
            <ul className="space-y-4">
              {["Shop All", "New Arrivals", "Best Sellers", "Sale"].map((item) => (
                <li key={item}>
                  <Link href={`/${item.toLowerCase().replace(" ", "-")}`} className="text-[10px] tracking-[0.3em] uppercase text-neutral-500 hover:text-[#0070f3] transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          {/* --- ASSISTANCE --- */}
          <div>
            <h4 className="text-[10px] tracking-[0.4em] uppercase font-bold text-black mb-8">Assistance</h4>
            <ul className="space-y-4">
          ...
          {/* --- NEWSLETTER --- */}
          <div className="space-y-6">
            <h4 className="text-[10px] tracking-[0.4em] uppercase font-bold text-black">Stay Connected</h4>
            <p className="text-[10px] tracking-widest text-neutral-400 uppercase leading-relaxed">
              Subscribe to receive updates on limited releases and private events.
            </p>
        ...
        <div className="pt-10 border-t border-neutral-50 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4 opacity-30 grayscale hover:opacity-100 transition-opacity">
            <div className="text-[9px] tracking-[0.2em] font-bold border border-black px-2 py-1 italic">VISA</div>
            <div className="text-[9px] tracking-[0.2em] font-bold border border-black px-2 py-1 italic">MC</div>
            <div className="text-[9px] tracking-[0.2em] font-bold border border-black px-2 py-1 italic">AMEX</div>
          </div>
        </div>
      </div>
    </footer>
